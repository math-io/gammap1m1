// To run this script, `cd` to the `./test/fixtures` directory and then execute in the terminal `runWandbox --file --compiler gcc-head --output output2.json ./runner2.cpp`.
...
int main() {
	vector<double> x = linspace( -1.99, 2.0, 100 );
